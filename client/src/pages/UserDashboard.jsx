...
const UserDashboard = () => {
  ...
  const data2 = [
    "1. Safe Drinking Water: Boil water before drinking or use water purification tablets to ensure it's safe. Store drinking water in clean, covered containers to prevent contamination.",
  ...
  const data3 = [
    '1. Community Participation: Attend community meetings to discuss water-related issues and solutions. Contribute ideas and opinions on decisions related to water supply management.',
